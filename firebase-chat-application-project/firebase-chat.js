(function () {
  ...
  var firebaseConfig = {
    apiKey: "AIzaSyBdPR8ESQLyEKucCXX8rIRj5vGfu4i_NRs",
    authDomain: "chat-app-2022-13fb0.firebaseapp.com",
    projectId: "chat-app-2022-13fb0",
    storageBucket: "chat-app-2022-13fb0.appspot.com",
    messagingSenderId: "435627006743",
    appId: "1:435627006743:web:8e2cf95612de1207afb552",
    measurementId: "G-2YWCMTZ76C"
  };
  // Initialize Firebase
  ...
  let currentUserEmail = userNameDisplay; // variable to store the current user's email
